...
const Hero = () => {
    const stats = [
        { label: 'Qualified Trainers', value: 92, icon: , color: 'from-blue-500 to-blue-400' },
        { label: 'Live Classes/Month', value: 250, icon: , color: 'from-purple-500 to-purple-400' },
        { label: 'Global Accreditations', value: 120, icon: , color: 'from-emerald-500 to-emerald-400' },
        { label: 'Courses Offered', value: 10, icon: , color: 'from-amber-500 to-amber-400' },
    ];
