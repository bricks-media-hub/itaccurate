...
>
  {[
    {
      icon: <img src="/icons/badge2.svg" alt="badge" className="w-6 h-6 sm:w-8 sm:h-8" />,
    ...
    {
      icon: <img src="/icons/users.svg" alt="users" className="w-6 h-6 sm:w-8 sm:h-8" />,
    ...
    {
      icon: <img src="/icons/growth.svg" alt="growth" className="w-6 h-6 sm:w-8 sm:h-8" />,
    ...
    {
      icon: <img src="/icons/globe.svg" alt="globe" className="w-6 h-6 sm:w-8 sm:h-8" />,
    ...
    >
      ...
      <div className="relative z-10 flex flex-col sm:flex-row sm:items-start gap-6">
        <div className={`${item.iconBg} p-4 rounded-lg sm:mr-4 flex items-center justify-center transform group-hover:rotate-12 transition-transform`}>
          {item.icon}
        </div>
        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed flex-grow">
          {item.content}
