...
const SuccessStats = () => {
  ...
  const placements = [
    ...
    { role: "Blockchain Developer", count: 320, icon: "/icons/blockchain.svg", color: "from-gray-800 to-gray-600" 
},
{ role: "Cybersecurity Engineer", count: 410, icon: "/icons/shield.svg", color: "from-red-400 to-red-600" },
{ role: "Cloud Architect (AWS/Azure/GCP)", count: 380, icon: "/icons/cloud-network.svg", color: "from-cyan-300 to-cyan-500" },
  ];
