...
const SuccessStats = () => {
  ...
  { role: "SAP BW/BI Developers", count: 290, icon: "/icons/increasing-graph.svg", color: "from-teal-300 to-teal-500" },
  ...
  { role: "Full Stack Engineer (MERN Stack)", count: 800, icon: "/icons/recurring.svg", color: "from-green-300 to-green-500" },
  ...
  // General Roles
  { role: "Frontend Developers", count: 1012, icon: "/icons/color.svg", color: "from-blue-200 to-blue-400" },
  { role: "Full Stack Developers", count: 1819, icon: "/icons/recurring.svg", color: "from-purple-200 to-purple-400" },
  ...
  { role: "Business Intelligence Developers", count: 588, icon: "/icons/increase-graph.svg", color: "from-teal-200 to-teal-400" }
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {placements.slice(0, visibleCount).map((placement, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="relative z-20 p-6 text-center flex flex-col justify-center">
