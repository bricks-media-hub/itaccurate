...
const CompanyLogoGlobe = () => {
  ...
  const companyLogos = [
    { name: 'TCS', logoPath: 'https://www.pc-tablet.co.in/wp-content/uploads/2024/04/Tata-Consultancy-Services-TCS.png' },
    { name: 'Transrail Lightning LTD', logoPath: 'https://transrail.in/images/logo.png' },
    { name: 'HCL', logoPath: 'https://download.logo.wine/logo/HCL_Technologies/HCL_Technologies-Logo.wine.png' },
    { name: 'Talentrise Technokrate Pvt Ltd.', logoPath: 'https://media.licdn.com/dms/image/v2/D4D16AQGZJDpqOXvoKQ/profile-displaybackgroundimage-shrink_200_800/profile-displaybackgroundimage-shrink_200_800/0/1714654088934?e=2147483647&v=beta&t=aynuwG2OOwsLpXWXus4SUGtvpWWFUo49W8SIeydHef8' },
    { name: 'JBL', logoPath: 'https://in.jbl.com/on/demandware.static/-/Library-Sites-SharedLibrary-JB/default/dw7c092073/images/jbl-logo.svg' },
    { name: 'Lupin Pharma', logoPath: 'https://www.sap.com/dam/application/shared/logos/customer/h-q/lupin-customer-logo.png' },
    // The following appear to be placeholder images from the second array
    { name: 'TCS', logoPath: 'https://i.postimg.cc/KYVK7kwn/image.png' },
    { name: 'Transrail Lightning LTD', logoPath: 'https://i.postimg.cc/7Zkj6KLz/image.png' },
    { name: 'HCL', logoPath: 'https://i.postimg.cc/Df6LMgWg/image.png' },
    { name: 'Talentrise Technokrate Pvt Ltd.', logoPath: 'https://i.postimg.cc/jjL0fvpS/image.png' },
    { name: 'JBL', logoPath: 'https://i.postimg.cc/fb3Q6BT0/image.png' },
    { name: 'Lupin Pharma', logoPath: 'https://i.postimg.cc/MKhGXJkG/image.png' }
];
  ...
  useEffect(() => {
    ...
    const placeLogos = async () => {
      ...
      for (let i = 0; i < totalLogos; i++) {
        ...
        const texture = await createTexture(company.logoPath);
