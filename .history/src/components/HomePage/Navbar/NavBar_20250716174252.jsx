...
const NavBar = () => {
    ...
    const handleMenuLeave = () => {
        const timeout = setTimeout(() => {
            if (activeSubMenu === null) setActiveMenu(null);
        }, 150);
        setHoverTimeout(timeout);
    };
    ...
    const handleSubMenuLeave = () => {
        const timeout = setTimeout(() => {
            setActiveSubMenu(null);
            if (activeMenu === null) setActiveSubMenu(null);
        }, 150);
        setHoverTimeout(timeout);
    };
    ...
    const navItems = [
        { 
            name: 'Courses', 
            icon: <div className="w-5 h-5 bg-gradient-to-br from-purple-500 to-blue-500 rounded-sm" />, 
            path: '#courses', 
            hasDropdown: true 
        },
        { 
            name: 'About', 
            icon: <div className="w-5 h-5 bg-gradient-to-br from-amber-500 to-orange-500 rounded-sm" />, 
            path: '/about-us' 
        },
        { 
            name: 'Blog', 
            icon: <div className="w-5 h-5 bg-gradient-to-br from-green-500 to-emerald-500 rounded-sm" />, 
            path: '/blog' 
        },
        { 
            name: 'Placements', 
            icon: <div className="w-5 h-5 bg-gradient-to-br from-rose-500 to-pink-500 rounded-sm" />, 
            path: '#placements', 
            hasDropdown: true, 
            subMenu: placementsSubMenu 
        },
        { 
            name: 'Contact', 
            icon: <div className="w-5 h-5 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-sm" />, 
            path: '/contact' 
        },
    ];
    ...
    return (
        <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled 
            ? 'bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-lg py-0 border-b border-gray-200/50 dark:border-gray-800'
            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between items-center py-3">
                    ...
                    <Link to="/" className="flex items-center z-50">
                        ...
                        >
                            <div className="bg-gradient-to-r from-purple-600 to-blue-500 w-10 h-10 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <nav className="hidden md:flex items-center space-x-1">
                        {navItems.map((item) => (
                            <div key={item.name} className="relative">
                                <Link
                                    to={item.path}
                                    className={`px-4 py-2.5 rounded-lg text-sm font-medium flex items-center group transition-all duration-200 ${
                                ...
                                >
                                    <motion.span 
                                        animate={{ rotate: activeMenu === item.name ? 360 : 0 }}
                                        className="mr-2"
                                    >
                                        {item.icon}
                                    </motion.span>
                                    ...
                                    {item.hasDropdown && activeMenu === item.name && (
                                        <motion.div
                                            ...
                                            className={`absolute left-0 mt-1 ${
                                                item.name === 'Courses' 
                                                    ? 'w-[700px] p-4 grid grid-cols-2 gap-3' 
                                                    : 'w-56 p-2'
                                            } bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-xl shadow-2xl z-50 border border-gray-200 dark:border-gray-700`}
                                                        ...
                                                        >
                                                            <Link to={course.link}>
                                                                <motion.div
                                                                    whileHover={{ 
                                                                        x: 5,
                                                                        backgroundColor: darkMode ? 'rgba(55, 65, 81, 0.5)' : 'rgba(249, 250, 251, 0.5)'
                                                                    }}
                                                                    className={`p-3 rounded-lg flex items-start transition-all ${
                                                                        activeSubMenu === course.title 
                                                                            ? 'bg-gray-100 dark:bg-gray-700' 
                                                                            : ''
                                                                    }`}
                                                                >
                                                                    <div className="bg-gradient-to-br from-purple-500 to-blue-500 w-10 h-10 rounded-md flex items-center justify-center mr-3 mt-1">
                                                            ...
                                                            <AnimatePresence>
                                                                {course.subMenu && activeSubMenu === course.title && (
                                                                    <motion.div
                                                                        ...
                                                                        className="absolute left-full top-0 ml-1 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-3 z-50 border border-gray-200 dark:border-gray-700"
                                                                    >
                                                                        <h4 className="font-bold text-gray-800 dark:text-white mb-2 px-2 pb-1 border-b border-gray-200 dark:border-gray-700">
                                                                            {course.title} Courses
                                                                        </h4>
                                                                        <ul className="space-y-1">
                                                                            {course.subMenu.map((subItem) => (
                                                                                ...
                                                                                >
                                                                                    <Link
                                                                                        to={subItem.link}
                                                                                        className="block px-3 py-2.5 rounded-md text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all"
                                                                                    >
                                                                                        {subItem.title}
                                                                                    </Link>
                                                                                </motion.li>
                                                ...
                                                <div className="space-y-1">
                                                    {item.subMenu.map((subItem) => (
                                                        ...
                                                        >
                                                            <Link 
                                                                to={subItem.link}
                                                                className="block px-4 py-3 rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all"
                                                            >
                                                                {subItem.menu}
                                                            </Link>
                                                        </motion.div>
                        ...
                        <div className="relative ml-2">
                            ...
                            <motion.input
                                ...
                                type="text"
                                className="w-32 pl-10 pr-4 py-2.5 bg-gray-100 dark:bg-gray-800 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                                placeholder="Search..."
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                            />
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={toggleDarkMode}
                            className="ml-3 p-2.5 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                            aria-label="Toggle dark mode"
                        >
                            {darkMode ? (
                                <div className="w-5 h-5 bg-gradient-to-tr from-amber-400 to-orange-500 rounded-full" />
                            ) : (
                                <div className="w-5 h-5 bg-gradient-to-tr from-gray-700 to-black rounded-full" />
                            )}
                        </motion.button>
                    </nav>
                    ...
                    <div className="md:hidden flex items-center space-x-3">
                        ...
                        >
                            <div className="relative w-6 h-6">
                                <motion.span
                                    className="absolute block w-full h-0.5 bg-gray-800 dark:bg-gray-200 rounded-full"
                                    animate={{ 
                                        y: isOpen ? 6 : 0, 
                                        rotate: isOpen ? 45 : 0 
                                    }}
                                />
                                <motion.span
                                    className="absolute block w-full h-0.5 bg-gray-800 dark:bg-gray-200 rounded-full mt-2"
                                    animate={{ opacity: isOpen ? 0 : 1 }}
                                />
                                <motion.span
                                    className="absolute block w-full h-0.5 bg-gray-800 dark:bg-gray-200 rounded-full mt-4"
                                    animate={{ 
                                        y: isOpen ? -6 : 0, 
                                        rotate: isOpen ? -45 : 0 
                                    }}
