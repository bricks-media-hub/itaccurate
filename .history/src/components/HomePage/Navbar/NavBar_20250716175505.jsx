...
const NavBar = () => {
    ...
    const navItems = [
        { 
            name: 'Courses', 
            icon: <img src='/icons/book.svg' alt='book' className="w-5 h-5" />, 
            path: '#courses', 
            hasDropdown: true 
        },
        { 
            name: 'About', 
            icon: <img src='/icons/user.svg' alt='user' className="w-5 h-5" />, 
            path: '/about-us' 
        },
        { 
            name: 'Blog', 
            icon: <img src='/icons/blog.svg' alt='blog' className="w-5 h-5" />, 
            path: '/blog' 
        },
        {
            name: 'Placements',
            icon: <img src='/icons/badge.svg' alt='badge' className="w-5 h-5" />,
            path: '#placements',
            hasDropdown: true,
            subMenu: placementsSubMenu
        },
        { 
            name: 'Contact', 
            icon: <img src='/icons/mail.svg' alt='mail' className="w-5 h-5" />, 
            path: '/contact' 
        },
    ];
    ...
    return (
        <header
            className={`fixed top-0 z-50 transition-all duration-300 px-2 md:px-0 w-full ${
                scrolled
                    ? 'dark:bg-gray-900 bg-white shadow-lg border-b dark:border-gray-800'
                ...
                <div className="flex justify-between items-center py-3">
                        ...
                        <div className="flex space-x-1 relative z-50">
                            {navItems.map((item) => (
                                ...
                                >
                                    <Link
                                        to={item.path}
                                        className="px-4 py-2 rounded-md text-sm font-medium dark:text-gray-300 text-gray-700 hover:dark:bg-gray-800 hover:bg-gray-100 transition-colors duration-200 flex items-center"
                                    >
                                        <span className="mr-2">
                                            {item.icon}
                                        </span>
                                    ...
                                    {item.hasDropdown && (
                                        <motion.div
                                            ...
                                            animate={{
                                                opacity: activeMenu === item.name ? 1 : 0,
                                                y: activeMenu === item.name ? 0 : 10,
                                                display: activeMenu === item.name ? 'block' : 'none'
                                            }}
                                            transition={{ duration: 0.2, ease: 'easeOut' }}
                                            className={`absolute mt-1 ${
                                                item.name === 'Courses'
                                                    ? 'left-1/2 transform -translate-x-1/2 w-[700px] p-4 grid grid-cols-2 gap-3'
                                                    : 'left-0 w-56 p-2'
                                            } bg-white dark:bg-gray-800 rounded-xl shadow-xl z-50 border border-gray-200 dark:border-gray-700`}
                                            onMouseEnter={handleDropdownEnter}
                                            onMouseLeave={handleDropdownLeave}
                                        >
                                            {/* Courses Dropdown */}
                                            {item.name === 'Courses' && (
                                                <>
                                                    {menuItems.map((course) => (
                                                        ...
                                                        >
                                                            <div
                                                                className={`p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors duration-200 flex items-start ${
                                                                    activeSubMenu === course.title ? 'bg-gray-50 dark:bg-gray-750' : ''
                                                                }`}
                                                            >
                                                                <span className="text-2xl mr-3 text-purple-600 dark:text-purple-400">
                                                                    <img 
                                                                ...
                                                                {course.subMenu && (
                                                                    <FiArrowRight className="ml-2 text-gray-400 group-hover:text-purple-500 self-center transition-colors" />
                                                                )}
                                                            </div>
                                                            ...
                                                            {course.subMenu && (
                                                                <motion.div
                                                                    ...
                                                                    animate={{
                                                                        opacity: activeSubMenu === course.title ? 1 : 0,
                                                                        x: activeSubMenu === course.title ? 0 : 10,
                                                                        display: activeSubMenu === course.title ? 'block' : 'none'
                                                                    }}
                                                                    transition={{ duration: 0.2, ease: 'easeOut' }}
                                                                    className="absolute left-full top-0 ml-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 z-50 border border-gray-200 dark:border-gray-700 max-h-96 overflow-y-auto"
                                                                >
                                                                    <h4 className="font-semibold text-gray-800 dark:text-white mb-2 px-2">
                                                                        {course.title} Courses
                                                                    </h4>
                                                                    <ul className="space-y-1">
                                                                        {course.subMenu.map((subItem) => (
                                                                            <li key={subItem.title}>
                                                                                <Link
                                                                                    to={subItem.link}
                                                                                    className="block px-3 py-2 rounded-md text-sm dark:text-gray-300 text-gray-700 hover:dark:bg-gray-750 hover:bg-gray-100 transition-colors duration-200"
                                                                                >
                                                                                    {subItem.title}
                                                                                </Link>
                                                                            </li>
                                                ...
                                                <ul className="space-y-1">
                                                    {item.subMenu.map((subItem) => (
                                                        <li key={subItem.menu}>
                                                            <Link
                                                                to={subItem.link}
                                                                className="block px-3 py-2.5 rounded-md text-sm dark:text-gray-300 text-gray-700 hover:dark:bg-gray-750 hover:bg-gray-100 transition-colors duration-200"
                                                            >
                                                                {subItem.menu}
                                                            </Link>
                                                        </li>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="hidden md:block relative">
                            ...
                            <input
                                type="text"
                                className="block w-40 pl-9 pr-3 py-2 border border-gray-200 dark:border-gray-700 rounded-md leading-5 dark:bg-gray-800 bg-gray-50 dark:text-gray-300 text-gray-700 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm transition-all duration-200"
                                placeholder="Search..."
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                            />
                        ...
                        <button
                            onClick={toggleDarkMode}
                            className="p-2 rounded-full dark:text-yellow-300 text-gray-700 hover:dark:bg-gray-800 hover:bg-gray-100 transition-colors duration-200"
                            aria-label="Toggle dark mode"
                        >
                            <motion.div
                                animate={{ rotate: darkMode ? 180 : 0 }}
                        ...
                        <button
                            ...
                            className="md:hidden p-2 rounded-md dark:text-gray-300 text-gray-700 focus:outline-none transition-colors"
                            aria-label="Toggle menu"
                        >
                            <motion.div
                                animate={{
