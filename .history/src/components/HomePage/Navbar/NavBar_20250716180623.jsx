                                                    ...
                                                    <>
                                                        {menuItems.map((course) => (
                                                            <Link to={course.link} key={course.title}>
                                                                ...
                                                                >
                                                                    <div
                                                                        className={`p-0 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 flex items-start ${activeSubMenu === course.title ? 'bg-gray-100 dark:bg-gray-700' : ''
                                                                            }`}
                                                                    >
