...
1 : 0,
                            ...
                            <button
                                onClick={toggleDarkMode}
                                className="md:block hidden ml-4 p-2 rounded-full dark:text-yellow-300 text-gray-700 hover:dark:bg-gray-800 hover:bg-gray-100 transition-colors duration-200"
                                aria-label="Toggle dark mode"
                            >
                                <motion.div
                        ...
                        <div className="md:hidden flex items-center">
                            <button
                                ...
                                aria-label="Toggle dark mode"
                            >
                                    {darkMode ? <img src='/icons/sun.svg' alt='sun' className='w-5 h-5'/> : <img src='/icons/moon.svg' alt='moon' className='w-7 h-7'/>}
                            </button>
