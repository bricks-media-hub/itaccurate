...
function KeyFeatures() {
  ...
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100 overflow-hidden relative">
      {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Modal form */}
        {showForm && (
          <FreeDemoForm onClose={() => setShowForm(false)} title1={"Attend a Free Live Class"} title2={"Reserve Your Seat"}/>
        )}
