...
<div className='flex flex-col -mt-16'>
  {/* Circular image placed over curved div */}
  <div className='relative w-full flex justify-center'>
    <div className='absolute -top-6 z-50'>
      <div className='h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden shadow-md'>
        <img 
          src={item.image} 
          alt={item.role} 
  ...
  <div key={index} className="px-3">
    <motion.div
      className="relative bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-2xl pt-20 pb-8 px-6 text-center shadow-lg h-full min-w-[400px] flex flex-col transition-all duration-300 hover:shadow-xl overflow-visible cursor-pointer mb-5"
      whileHover={{ y: -10 }}
    ...
    >
      {/* Curved top layer */}
      <div className="absolute top-0 left-0 w-full h-12 rounded-b-[50%] bg-white dark:bg-gray-800 z-0"></div>

      <div className="flex flex-col p-4 z-10">
        <p className="text-gray-600 dark:text-gray-300 mb-5 line-clamp-5 italic text-center">
          "{item.review}"
        </p>
      ...
      <div className="flex justify-center items-center absolute -top-5 left-6 bg-slate-300 dark:bg-slate-500 rounded-full h-12 w-12 z-10">
