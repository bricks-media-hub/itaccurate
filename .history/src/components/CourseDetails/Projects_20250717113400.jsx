...
const NextArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute ml-5 right-0 top-1/2 -translate-y-1/2 z-10 bg-white dark:bg-slate-800 p-3 rounded-full shadow-lg hover:bg-blue-50 dark:hover:bg-slate-700 transition-all transform hover:scale-110"
    aria-label="Next"
  >
