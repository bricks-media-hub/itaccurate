      ...
      <AnimatePresence>
        {activeIndex === index && (
          <motion.div
            ...
            className={`z-50 ${position === "top" ? "top-full mt-0" : position === "bottom" ? "bottom-full mb-4" : "top-full mt-4"} w-[90vw] max-w-md bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 text-left backdrop-blur-sm`}
            // style={{ zIndex: 1000 + index }}
          >
            <div 
              className={` ${position === "top" ? "-top-2" : position === "bottom" ? "-bottom-2" : "-top-2"} left-1/2 transform -translate-x-1/2 w-4 h-4 bg-white dark:bg-gray-800 rotate-45 ${position === "top" ? "border-t border-l" : position === "bottom" ? "border-b border-r" : "border-t border-l"} border-gray-200 dark:border-gray-700`}
            />
...
//             >
//               <div
//                 className="absolute w-4 h-4 bg-white dark:bg-gray-800 transform rotate-45 -z-10"
//                 style={{
//                   ...(isMobile
//                     ? {
//                       top: '50%',
