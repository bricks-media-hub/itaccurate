    ...
    <div className="dark:bg-gray-900">
      ...
      <section className="mt-16">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-8xl mx-auto flex flex-col lg:flex-row gap-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-5 sm:p-8 transition-all duration-300">
