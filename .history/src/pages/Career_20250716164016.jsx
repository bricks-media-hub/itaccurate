                            ...
                            >
                                <div className="p-8">
                                    <motion.div
                                        ...
                                        className="self- mb-6 w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center group-hover:bg-blue-600 transition-colors duration-300"
                                    >
