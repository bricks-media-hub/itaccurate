                  ...
                  <div className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
                    {placementStats.map((stat, index) => (
                      <motion.div
                        ...
                        className="flex flex-col bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl p-4 text-center shadow-sm hover:shadow-md transition"
                      >
                        <div className="">
                          {/* icon */}
                          <div>
